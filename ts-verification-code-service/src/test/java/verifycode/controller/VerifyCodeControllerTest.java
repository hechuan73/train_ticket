...
public class VerifyCodeControllerTest {
    ...
    public void testVerifyCode(){
        ...
        Mockito.when(verifyCodeService.verifyCode(request, response, "verifyCode", headers)).thenReturn(true);
        Boolean result= verifyCodeController.verifyCode("verifyCode", request, response, headers);
